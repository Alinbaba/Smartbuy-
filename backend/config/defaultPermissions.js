...
// ======================================================
//
// Central definition of all built-in permissions available
// throughout the SmartBuy platform.
//
// Permission name is generated as:
//
//     module.action
//
// Example:
...
//     orders.refund
//
// System permissions are seeded automatically into MongoDB.
// Do not rename module/action values casually because existing
// roles and authorization rules depend on them.
//
// ======================================================
...
const defaultPermissions = [
...

    {
        module: "dashboard",
        action: "view",
        description: "View authorized SmartBuy dashboards"
    },
...

    {
        module: "wallets",
        action: "debit",
        description: "Debit wallets"
    },

    {
        module: "wallets",
        action: "freeze",
        description: "Freeze wallets"
    },
...

    {
        module: "ai",
        action: "use",
        description: "Use authorized AI features"
    },
